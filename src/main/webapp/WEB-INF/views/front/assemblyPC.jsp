							  ...
							  <div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								  <div class="panel-body panel_text">
									<ul>
										<li><a href="/assemblyPC?CATEGORY1_NUM=1&CATEGORY2_NUM=1"> <strong>CPU</strong></a></li>
				...
				<div class="col-md-9 w3ls_mobiles_grid_right">
					...
					<H1 style="margin: 10px;"> CPU </H1>
						<div class="select_list">
							...
							<ul>
								<select class="select" name="TAG_1" id="TAG_1" title="소켓구분 선택">
								...
								<select class="select" name="TAG_2" id="TAG_2" title="쓰레드 선택">
									<option value='' selected> -- 쓰레드 -- </option>
									<option value='쓰레드20개' >  쓰레드 20개  </option>
									<option value='쓰레드16개' >  쓰레드16개  </option>
									<option value='쓰레드12개' >  쓰레드12개  </option>
									<option value='쓰레드8개' >  쓰레드8개  </option>
									<option value='쓰레드4개' >  쓰레드4개  </option>
									<option value='쓰레드2개' >  쓰레드2개  </option>
								</select>
								
								<select class="select" name="TAG_3" id="TAG_3" title="코어 형태">
									<option value='' selected> -- 코어 형태 -- </option>
									<option value='10코어' >  10코어  </option>
									<option value='옥타(8)코어' >  옥타(8)코어  </option>
									<option value='헥사(6)코어' >  헥사(6)코어  </option>
									<option value='쿼드(4)코어' >  쿼드(4)코어  </option>
									<option value='듀얼(2)코어' >  듀얼(2)코어  </option>
								
								</select>
							</ul>
							<ul>
								<select class="select" name="TAG_4" id="TAG_4" title="연산체제 선택">
									<option value='' selected> -- 연산체제 -- </option>
									<option value='64비트' > 64비트  </option>
									<option value='32비트' > 32비트 </option>
								</select>
							</ul>
						</div>
					</div>
