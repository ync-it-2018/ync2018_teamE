								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								  <div class="panel-body panel_text">
									<ul>
										...
										<li><a href="/assemblyPC?CATEGORY1_NUM=1&CATEGORY2_NUM=6"> <strong>하드디스크</strong> </a></li>
						...
						<div class="select_list">
							<ul>
								<select class="select" name="CATEGORY3_NUM" id="CATEGORY3_NUM" title="제조사" style="width:89%;">
									...
									<option value='레버노' >  레버노   </option>
									<option value='삼성전자' >  삼성전자   </option>
									<option value='크로바하이텍' >  크로바하이텍   </option>
									<option value='한국캐드컴' >  한국캐드컴  </option>
							...
							<ul>
								<select class="select" name="TAG_1" id="TAG_1" title="제품 분류">
									...
									<option value='HDD(PC용)' >  HDD (PC용)   </option>
									<option value='HDD(노트북용)' >  HDD (노트북용)  </option>
									<option value='HDD(기업용)' >  HDD (기업용)  </option>
									<option value='HDD(리퍼비시)' >  HDD (리퍼비시)  </option>
									<option value='HDD복사기' >  HDD 복사기  </option>
								</select>
								<select class="select" name="TAG_2" id="TAG_2" title="디스크 크기">
									<option value='' selected> -- 디스크 크기 -- </option>
									<option value='8.9cm(3.5형)' >  8.9cm(3.5형)  </option>
									<option value='6.4cm(2.5형)' >  6.4cm(2.5형)  </option>
									<option value='4.6cm(1.8형)' >  4.6cm(1.8형)  </option>
								</select>
								<select class="select" name="TAG_3" id="TAG_3" title="디스크 용량">
							...
							<ul>
								<select class="select" name="TAG_4" id="TAG_4" title="인터페이스">
									...
									<option value='SA-SCSI' >  SA-SCSI </option>
									<option value='SA-SCSI(6Gb/s)' >  SA-SCSI(6Gb/s) </option>
								</select>
							
								<select class="select" name="TAG_5" id="TAG_5" title="회전수">
									<option value='' selected> -- 회전수 -- </option>
									<option value='15,000RPM' >  15,000RPM  </option>
									<option value='10,000RPM' >  10,000RPM </option>
									<option value='7,200RPM' >  7,200RPM </option>
									<option value='5,900RPM' >  5,900RPM </option>
									<option value='5,400RPM' >  5,400RPM </option>
									
								</select>
								<select class="select" name="TAG_6" id="TAG_6" title="버퍼 용량">
									<option value='' selected> -- 버퍼 용량 -- </option>
									<option value='메모리256MB' >  메모리256MB  </option>
									<option value='메모리128MB' >  메모리128MB  </option>
									<option value='메모리64MB' >  메모리64MB  </option>
									<option value='메모리32MB' >  메모리32MB  </option>
								</select>
							</ul>
						</div>
					</div>
