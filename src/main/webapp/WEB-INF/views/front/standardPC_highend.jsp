...
<script type="text/javascript">
	...
	function Product_Search() {
	    ...
	    location.replace("/standardPC?CATEGORY1_NUM=2&CATEGORY2_NUM=17&CATEGORY3_NUM="+CATEGORY3_NUM+"&TAG_1="+TAG_1+"&TAG_2="+TAG_2+"&TAG_3="+TAG_3);
		...
		<div class="container" style="padding-left: 0px;">
			<div class="w3ls_mobiles_grids">
							  ...
							  <div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
								  <div class="panel-body panel_text">
									<ul>
										<li><a href="/standardPC?CATEGORY1_NUM=2&CATEGORY2_NUM=15"> <strong>GAME</strong></a></li>
										<li><a href="/standardPC?CATEGORY1_NUM=2&CATEGORY2_NUM=16">OFFICE</a></li> 
										<li><a href="/standardPC?CATEGORY1_NUM=2&CATEGORY2_NUM=17"> HIGH-END </a></li>
									</ul>
								  </div>
								</div>
							  </div>
				...
				<div class="col-md-9 w3ls_mobiles_grid_right">
					...
					<H1 style="margin: 10px;"> HIGH-END </H1>
