			...
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="form-group">
						...
						<input type="text" name='ask_title' class="form-control" value="RE:${CServiceVO.ask_title}" readonly="readonly">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="text" name="admin_id" class="form-control" value="${CServiceVO.admin_id}" readonly="readonly">
					</div>
				</div>
				<!-- /.box-body -->
